...
def qa():
    ...
    table(d, ["評分項", "評審可能追問", "回答錨點"], [("主題 30%", "為什麼不是普通 RAG？", "獨立性、矛盾、雙軸信心、可回溯"), ("商業 25%", "HOYA BIT 為什麼需要？", "降低查核時間、內容責任邊界、白標 API"), ("技術 20%", "真的能跑、能降級嗎？", "Trust Kernel 與 Bedrock 分工、Log、時間預算"), ("創意 15%", "哪個功能是你們獨有？", "四個信任工具與反事實 A/B"), ("完成 10%", "當場失敗怎麼辦？", "四份交付、獨立降級、可診斷失敗")], [1.05, 2.75, 3.0])
