...
3. **新增 @media (max-width: 1024px) breakpoint**：
   - 縮小 `--hermes-rail` 到 `clamp(190px, 18vw, 230px)`
   - 或讓右側 rail 稍窄：`--hermes-right-rail: clamp(190px, 18vw, 220px)`
...
- [ ] 左側面板在 1080p 下可捲動，輸入框/按鈕可觸及
- [ ] 右側面板在 1024px 下可捲動，信任分數完整可見
- [ ] 大螢幕（≥1280px）行為不受影響
- [ ] ≤900px 響應式（右側隱藏）行為不受影響
- [ ] frontend lint、tests、build 通過
