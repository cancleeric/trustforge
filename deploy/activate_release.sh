...
BEDROCK_RPS_SCHEDULER_COMMAND="REGION=${REGION} TRUSTFORGE_BEDROCK_RPS_BACKEND=${BEDROCK_RPS_BACKEND} TRUSTFORGE_BEDROCK_RPS_REGION=${BEDROCK_RPS_REGION} TRUSTFORGE_BEDROCK_RPS_TABLE=${BEDROCK_RPS_TABLE} bash deploy/install_hermes_scheduler.sh"
