...
BEDROCK_RPS_SCHEDULER_COMMAND="TRUSTFORGE_BEDROCK_RPS_BACKEND=${BEDROCK_RPS_BACKEND} TRUSTFORGE_BEDROCK_RPS_REGION=${BEDROCK_RPS_REGION} TRUSTFORGE_BEDROCK_RPS_TABLE=${BEDROCK_RPS_TABLE} TRUSTFORGE_FORMAL_RUN_DYNAMODB_TABLE=${FORMAL_RUN_TABLE} TRUSTFORGE_TOKEN_SSM_PREFIX=${TOKEN_SSM_PREFIX} TRUSTFORGE_SHARED_ANALYSIS_DB_PATH=${SHARED_ANALYSIS_DB_PATH} bash deploy/install_hermes_scheduler.sh"
