...
EXTRA_UNIT_ENV="${EXTRA_UNIT_ENV}Environment=TRUSTFORGE_ATOMIC_BATCH_TABLE=${ATOMIC_BATCH_TABLE}\n"
EXTRA_UNIT_ENV="${EXTRA_UNIT_ENV}Environment=TRUSTFORGE_ATOMIC_BATCH_CONFIG_VERSION=${ATOMIC_BATCH_CONFIG_VERSION}\n"
EXTRA_UNIT_ENV="${EXTRA_UNIT_ENV}Environment=TRUSTFORGE_ATOMIC_BATCH_EXCLUSIVE=${ATOMIC_BATCH_EXCLUSIVE}\n"
EXTRA_UNIT_ENV="${EXTRA_UNIT_ENV}Environment=TRUSTFORGE_SHARED_ANALYSIS_DB_PATH=${SHARED_ANALYSIS_DB_PATH}\n"
EXTRA_UNIT_ENV="${EXTRA_UNIT_ENV}Environment=TRUSTFORGE_MULTI_ANGLE_DAILY_BUDGET_USD=${MULTI_ANGLE_DAILY_BUDGET_USD}\n"
