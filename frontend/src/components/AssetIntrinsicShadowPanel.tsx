...
const copy = {
  'zh-TW': {
    ...
    officialDescription: '這項資產結構調整已通過發行能力與 promotion receipt 驗證；它只調整信任分，不直接改變市場方向。',
  ...
  en: {
    ...
    officialDescription: 'This asset-structure adjustment has a verified release capability and promotion receipt. It adjusts trust only and does not directly set market direction.',
    receipt: 'Promotion receipt',
