...
export default function HermesDashboard() {
  ...
  return (
    <div className="hermes-root" style={{ width: '100vw', height: '100vh', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#02040a' }}>
      <div style={{ width: 1440, height: 900, flexShrink: 0, position: 'relative', overflow: 'hidden', background: 'radial-gradient(ellipse at 50% 30%,#0b1420 0%,#02040a 72%)', color: 'var(--color-hermes-tx)', border: '1px solid rgba(140,190,210,.08)', boxShadow: '0 60px 160px rgba(0,0,0,.7)', transform: `scale(${scale})`, transformOrigin: 'center center' }}>
        {/* scanline + vignette */}
