...
**TrustForge 是加密資訊的「信源熔爐」——把多源雜訊提煉成帶溯源、帶信心區間的市場判斷。**
...
| 輸出結構 | 一句話結論 | 事實層→推論層→結論，含信心區間+反方證據 |
...
- **信心只有 0.62，因為鏈上資料在這次分析中只有 1 筆獨立來源**（明確說出限制）
