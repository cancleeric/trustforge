...
| Authoritative text pending | Article 17(3) sectoral Union-law incorporation route | Conditional; relevant sectoral Union-law QMS or equivalent-function applicability and incorporation pending | High-risk provider subject to another relevant Union-law QMS or equivalent function; role pending | Exact applicable high-risk-path date pending Compliance Counsel verification; no new checkpoint assigned | Article 17(1) aspects may be incorporated into the applicable sectoral QMS or equivalent function | Sectoral legal basis, equivalent function, incorporation, exact artifacts, activation and effectiveness unverified | Not assessed | Verify legal basis, actor, incorporation and exact-version evidence |
| Authoritative text pending | Article 17(4) financial-institution deemed-fulfilment route | Conditional; financial-institution status, applicable Union financial-services-law internal-governance／arrangement／process requirements and compliance pending | High-risk provider that is a financial institution subject to those Union-law requirements; role pending | Exact applicable high-risk-path date pending Compliance Counsel verification; no new checkpoint assigned | Compliance deems the QMS obligation fulfilled; Article 17(1)(g), (h), (i) remain mandatory and Article 40 harmonised standards must be taken into account | Actor status, applicable law, compliance, express-duty controls, standards consideration, exact artifacts, activation and effectiveness unverified | Not assessed | Verify every condition and retained duty against an exact version; do not infer a general financial-sector exemption |
...
| Authoritative text pending | Article 25(3) Annex I Section A product-manufacturer route／Article 16 consequence | Conditional; limited to an Annex I Section A product manufacturer. Trigger A: high-risk AI system and product placed on market together under manufacturer's own name／trademark. Trigger B: after product placement, that system put into service under manufacturer's name／trademark. Trigger facts and applicability pending. | Once exact-version review confirms applicability and a trigger is established, the product manufacturer SHALL be considered provider and IS subject to Article 16 obligations | Exact applicable Article 6(1) path date pending Compliance Counsel verification; no new checkpoint assigned | Product integration, market／service sequence, identity, change and supplier controls | Annex I Section A product, high-risk system, manufacturer identity, name／trademark, placement／service sequence and Article 6(1) evidence unverified | Not assessed | Verify every trigger fact and exact-version evidence; keep separate from Article 25(1), off-label use and foreseeable misuse |
