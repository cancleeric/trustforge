...
| 分類 | internal-draft |
| 變更摘要／取代文件 | 建立情境與利害關係人初始登錄／not-applicable（初版） |
| Repository path | `docs/aims/01-scope/context-and-stakeholders.md` |
...
| CTX-07 | 外部 | AI、金融資訊、隱私、著作權與供應商義務可能變動 | 需由合規 owner 建立適用義務清冊 | `docs/plans/PLAN-ISO-IEC-42001-AIMS-IMPROVEMENT-2026-08-01.md`；具體義務待合規評估 | 待 CEO 指派 | 2026-08-01 初始盤點 | 待核准時設定 | 僅計劃 |
...
| STK-04 | 資料主體／內容作者／資料提供者 | 合法、適當、可追溯的資料處理與引用 | `docs/competition/COMPETITION-OFFICIAL.md` 的來源回溯要求；法定／契約需求待合規確認 | 資料清冊、權利基礎、retention、移除流程 | 待合規指派 | 2026-08-01 初始盤點 | 待核准時設定 | 僅計劃 |
| STK-05 | AWS／其他供應商 | 契約、可接受使用與技術限制被遵守 | `README.md`、`pyproject.toml`；合約／服務條款待正式盤點 | due diligence、合約與變更 review | 待指派 | 2026-08-01 初始盤點 | 待核准時設定 | 僅計劃 |
...
| STK-07 | 合規、法務與 reviewer | 不誤導的公開聲明、可查驗紀錄 | Issue #1247 acceptance criteria、`AGENTS.md` reviewer gate；正式訪談待補 | 聲明核准 gate、稽核 trail | 待指派 | 2026-08-01 初始盤點 | 待核准時設定 | 僅計劃 |
| STK-08 | 受錯誤或誤用影響的個人／群體 | 避免傷害、申訴與事件處理 | `docs/plans/PLAN-ISO-IEC-42001-AIMS-IMPROVEMENT-2026-08-01.md`；具體需求待 impact assessment 確認 | impact assessment、incident/CAPA、申訴入口 | 待指派 | 2026-08-01 初始盤點 | 待核准時設定 | 僅計劃 |
