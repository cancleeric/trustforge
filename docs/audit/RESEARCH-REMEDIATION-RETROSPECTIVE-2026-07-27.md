...
| PR #744 | Merged as `1c90762382c9aa28c54dee6c3cc9f7f82eec09b6` from head `24c47a81747e1126c6cff5806d6caa05cf22ef7f` | GitHub has zero reviews. Subsequent real-sample evaluation used seeded random shuffling and reported a non-AUC metric as `auc_proxy`. | #752 / PR #755 replaces this with a chronological, embargoed evaluation and honest metrics. PR #755 is **open, not merged** as of this update. |
...
| #752 / PR #755 | **OPEN / NOT MERGED** at head `55817d88383a64620c3b5b6ebb11a04199c9f994` | Reviewer requested: `@nicholaswang941013` (no submitted GitHub review). Initial `/codex-review` returned REQUEST CHANGES for reversed conformal quantile direction, missing outcome embargo, permissive family eligibility, UTC normalization, and partition-family gates. The exact head later received a commit-bound `/codex-review` APPROVE. Eye: 0 critical / 0 warning. Full pre-push: PASS — backend 4,750 passed / 11 skipped, frontend 459 passed, competition QA 24/24, plus lint, build, data-contract, source-stub, and diff checks. Targeted checks: 26 passed with ruff, mypy, and diff checks green. These gates do not turn the open PR into a merged or released change. |
